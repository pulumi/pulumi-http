...
namespace Pulumi.Http
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Http.version.txt");
    ...
    internal sealed class HttpResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HttpResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
